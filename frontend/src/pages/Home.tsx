...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const filtered = materials.filter(m => m.title.toLowerCase().includes(loweredKeyword));
      ...
      <div className="px-4 py-2">
          ...
          <div className="relative z-10 text-white">
            ...
            <div className="flex justify-between items-center mb-3">
              ...
              <button 
                ...
                className="flex items-center space-x-1 bg-white/20 hover:bg-white/30 rounded-full px-3 py-1.5 text-[13px] font-medium backdrop-blur-sm border border-white/30 transition-colors"
              >
                <AlertCircle size={15} />
                <span>投诉建议</span>
              </button>
        ...
        <div className="space-y-3 pb-20">
          {loading ? (
            ...
            <div className="text-center py-10 text-gray-400 text-sm">暂无数据或未搜索到相关文章</div>
          )}
        </div>
      </div>
    </div>
